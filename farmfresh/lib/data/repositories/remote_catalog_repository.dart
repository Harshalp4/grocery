...
class RemoteCatalogRepository implements CatalogRepository {
  ...
  Future<void> submitReview(String productId, int rating, String text,
      {String? area}) async {
    await _api.postJson('/products/$productId/reviews', {
      'rating': rating,
      'text': text,
  ...
  Future<List<Product>> getWishlist() async {
    final data = await _api.getJson('/wishlist') as List<dynamic>;
    return data.map((e) => _product(e as Map<String, dynamic>)).toList();
  }

  @override
  Future<void> addToWishlist(String productId) =>
      _api.postJson('/wishlist', {'productId': productId});

  @override
  Future<void> removeFromWishlist(String productId) =>
      _api.deleteJson('/wishlist/$productId');

  @override
  Future<List<PromoBanner>> getBanners() async {
    final data = await _api.getJson('/banners') as List<dynamic>;
    return data.map((e) {
      ...
      return PromoBanner(
        ...
        actionValue: j['actionValue'] as String?,
      );
    }).toList();
  }
